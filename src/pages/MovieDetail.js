...
import backup from "../assects/backup.jpg";
...
export const MovieDetail=()=> {
  ...
  useEffect(()=>{
    async function fetchMovie(){
      const response=await fetch(`https://api.themoviedb.org/3/movie/${params.id}?api_key=f2700b89f82747ac5287e56110ebd9a7&language=en-US`);
  ...
  return (
    <main>
      <section className="flex justifiy-around flex-wrap py-5 ">
        <div className="max-w-md px-10 ">
          <img  className="rounded " src={image} alt={movie.title} />
        </div>
        <div className="max-w-2xl px-10 text-gray-700 text-lg dark:text-white  ">
